...
if (isset($_POST['update'])) {
    ...
    if ($_FILES['foto']['name'] != "") {
        ...
        // Update data termasuk foto dan mapel
        $q = "UPDATE users SET nama='$nama', mapel='$mapel', tempat_lahir='$tempat', tanggal_lahir='$tanggal', foto='$newFoto' WHERE id='$id'";
    } else {
        // Update data tanpa ganti foto, tapi update mapel
        $q = "UPDATE users SET nama='$nama', mapel='$mapel', tempat_lahir='$tempat', tanggal_lahir='$tanggal' WHERE id='$id'";
    }
...
<div class="form-card">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="mapel" value="<?= isset($data['mapel']) ? htmlspecialchars($data['mapel']) : ''; ?>" required>
        </div>
        ...
        <div class="form-group">
            <label>Foto</label>
            <img src="../uploads/<?= htmlspecialchars($data['foto']); ?>" class="old-photo">
