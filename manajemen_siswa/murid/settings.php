...
/* --- 4. EMPTY STATE STYLE (SAMA DENGAN GURU) --- */
...
<div class="main">
    ...
    <div class="topbar">
        <div class="welcome">
            <h1>Settings Akun</h1>
            <p>Kelola profil dan preferensi siswa Anda.</p>
        </div>
    ...
    <div class="empty-state-container">
        ...
        <p class="empty-subtitle">
            Fitur pengaturan profil siswa sedang dikembangkan. Nantinya kamu bisa mengubah password dan foto profil di sini.
        </p>
    </div>
